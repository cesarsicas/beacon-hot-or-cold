 ...
 */
public class EddystoneUrlUtils {
  private static final String TAG = EddystoneUrlUtils.class.getSimpleName();

  public static final SparseArray<String> URI_SCHEMES = new SparseArray<String>() {{
    put((byte) 0, "http://www.");
  ...
  public static final SparseArray<String> URL_CODES = new SparseArray<String>() {{
    put((byte) 0, ".com/");
    put((byte) 1, ".org/");
    put((byte) 2, ".edu/");
    put((byte) 3, ".net/");
  ...
  public static String decodeUrl(byte[] serviceData) {
