...
package br.com.cesarsicas.beaconhotorcold.Domains.Main.View.Adapters;
...
import br.com.cesarsicas.beaconhotorcold.Domains.HotOrCold.View.Activities.HotOrColdActivity;
...
public class BeaconArrayAdapter extends ArrayAdapter<Beacon> implements Filterable {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    LinearLayout containerBeacon = (LinearLayout) convertView.findViewById(R.id.containerBeacon);

    containerBeacon.setClickable(true);

    containerBeacon.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent intent = new Intent(context, HotOrColdActivity.class);
        intent.putExtra(HotOrColdActivity.DEVICE_ADDRESS, beacon.deviceAddress);
