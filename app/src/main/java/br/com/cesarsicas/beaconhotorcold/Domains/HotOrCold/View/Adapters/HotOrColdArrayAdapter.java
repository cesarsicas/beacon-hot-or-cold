...
package br.com.cesarsicas.beaconhotorcold.Domains.HotOrCold.View.Adapters;
 ...
 */
public class HotOrColdArrayAdapter extends ArrayAdapter<Beacon> implements Filterable {
  ...
  public HotOrColdArrayAdapter(Context context, int resource, List<Beacon> allBeacons) {
